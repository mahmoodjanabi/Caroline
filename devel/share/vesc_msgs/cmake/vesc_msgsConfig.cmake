...
if("TRUE" STREQUAL "TRUE")
  set(vesc_msgs_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/vesc_msgs)
...
if(NOT "/home/ubuntu/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/vesc_msgs/${idir}'.  ${_report}")
    endif()
