...
if("TRUE" STREQUAL "TRUE")
  set(vesc_driver_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/vesc_driver)
...
if(NOT "/home/ubuntu/catkin_ws/src/vesc_driver/include " STREQUAL " ")
  set(vesc_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/vesc_driver/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/vesc_driver/${idir}'.  ${_report}")
    endif()
